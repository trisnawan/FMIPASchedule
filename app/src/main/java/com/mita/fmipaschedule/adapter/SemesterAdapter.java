...
public class SemesterAdapter extends RecyclerView.Adapter<SemesterAdapter.MyViewHolder> {
    ...
    private final List<SemesterModel> list;
    private ListInterface listInterface;

    public SemesterAdapter(Context context, List<SemesterModel> list) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.row_semester, parent, false);
